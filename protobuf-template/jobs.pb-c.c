...
const ProtobufCEnumValue sstack_payload_t__sstack_nfs_command_t__enum_values_by_number[32] =
{
  { "SSTACK_ADD_STORAGE", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__SSTACK_ADD_STORAGE", 1 },
  { "SSTACK_REMOVE_STORAGE", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__SSTACK_REMOVE_STORAGE", 2 },
  { "SSTACK_ADD_STORAGE_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__SSTACK_ADD_STORAGE_RSP", 3 },
  { "SSTACK_REMOVE_STORAGE_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__SSTACK_REMOVE_STORAGE_RSP", 4 },
  { "NFS_GETATTR", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_GETATTR", 5 },
  { "NFS_SETATTR", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_SETATTR", 6 },
  { "NFS_LOOKUP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_LOOKUP", 7 },
  { "NFS_ACCESS", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_ACCESS", 8 },
  { "NFS_READLINK", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READLINK", 9 },
  { "NFS_READ", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READ", 10 },
  { "NFS_WRITE", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_WRITE", 11 },
  { "NFS_CREATE", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_CREATE", 12 },
  { "NFS_MKDIR", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_MKDIR", 13 },
  { "NFS_SYMLINK", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_SYMLINK", 14 },
  { "NFS_MKNOD", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_MKNOD", 15 },
  { "NFS_REMOVE", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_REMOVE", 16 },
  { "NFS_RMDIR", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_RMDIR", 17 },
  { "NFS_RENAME", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_RENAME", 18 },
  { "NFS_LINK", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_LINK", 19 },
  { "NFS_READDIR", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READDIR", 20 },
  { "NFS_READDIRPLUS", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READDIRPLUS", 21 },
  { "NFS_FSSTAT", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_FSSTAT", 22 },
  { "NFS_FSINFO", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_FSINFO", 23 },
  { "NFS_PATHCONF", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_PATHCONF", 24 },
  { "NFS_COMMIT", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_COMMIT", 25 },
  { "NFS_GETATT_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_GETATT_RSP", 26 },
  { "NFS_LOOKUP_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_LOOKUP_RSP", 27 },
  { "NFS_ACCESS_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_ACCESS_RSP", 28 },
  { "NFS_READLINK_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READLINK_RSP", 29 },
  { "NFS_READ_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_READ_RSP", 30 },
  { "NFS_WRITE_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_WRITE_RSP", 31 },
  { "NFS_CREATE_RSP", "SSTACK_PAYLOAD_T__SSTACK_NFS_COMMAND_T__NFS_CREATE_RSP", 32 },
};
static const ProtobufCIntRange sstack_payload_t__sstack_nfs_command_t__value_ranges[] = {
{1, 0},{0, 32}
};
const ProtobufCEnumValueIndex sstack_payload_t__sstack_nfs_command_t__enum_values_by_name[33] =
{
  { "NFS_ACCESS", 7 },
  { "NFS_ACCESS_RSP", 27 },
  { "NFS_COMMIT", 24 },
  ...
  { "NFS_WRITE", 10 },
  { "NFS_WRITE_RSP", 30 },
  { "SSTACK_ADD_STORAGE", 0 },
  { "SSTACK_ADD_STORAGE_RSP", 2 },
  { "SSTACK_REMOVE_STORAGE", 1 },
  { "SSTACK_REMOVE_STORAGE_RSP", 3 },
};
